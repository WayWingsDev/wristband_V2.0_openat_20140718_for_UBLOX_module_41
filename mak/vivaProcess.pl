...
my @viList = (&zImageProcess::GetZImageInfo(),
              &zImageProcess::GetBootZImageInfo(),
              &dcmcomp_process::GetInfo(),
              &aliceProcess::GetInfo());
my $separateLine = "=============================================================";
...
copy($vivaBinary, $vivaBinaryBackup) or
   &vivaHelper::ErrorHandler("Cannot backup VIVA header binary $vivaBinary: $!");

# Open VIVA binary
open my $inout, "+<$vivaBinary" or
   &vivaHelper::ErrorHandler("Cannot open VIVA header binary $vivaBinary: $!");
binmode $inout;
