...
my $IMAGE_ZI_BASE_LEN = 4;
my $IMAGE_ZI_SIZE_LEN = 4;
...
sub parseRegionInformation
{
    ...
    foreach (@exec_bins) {
        ...
        $img_pool = unpack('V1', $img_pool);
        $img_group = unpack('V1', $img_group);       
        $img_exec_base = unpack('V1', $img_exec_base);       
