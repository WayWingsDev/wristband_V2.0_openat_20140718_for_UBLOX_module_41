...
typedef enum
{
    OA_SMS_WRISTBAND_NULL = 0,
    OA_SMS_WRISTBAND_STATUS,
    OA_SMS_WRISTBAND_LOCATE,
    OA_SMS_WRISTBAND_MONITOR
}oa_sms_for_wristband;
...
extern oa_uint8 g_current_band_number;
...
extern void oa_sms_handler_for_wristband(oa_sms_for_wristband mode);
